...
def generate_launch_description():
    ...
    # Point to the custom file we just created
    nav2_params_path = os.path.join(my_pkg, 'config', 'my_nav2_params.yaml')
    ...
    # --- 5. ODOMETRY (Generate odom from Lidar) ---
    rf2o_node = Node(
    ...
    return LaunchDescription([
        lidar_launch,
        # camera_launch, # Commented out
        lidar_tf,
        # camera_tf,     # Commented out
        slam_launch,
        nav2_launch,
        box_estimator_node,
